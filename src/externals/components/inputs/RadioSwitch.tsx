import React, { ChangeEventHandler, Dispatch, MouseEventHandler, ReactNode, SetStateAction, useEffect, useRef, useState } from 'react'
                            ...
                            onChange={(e) => {
                                if (!disabled) {
                                    ...
                                    setter((prev: typeStateForm) => ({
                                        ...
                                        uncompleteds: prev.uncompleteds?.filter((uncompleted) => (
                                            uncompleted != name
                                        )) ?? []
                                    }))
                                }
